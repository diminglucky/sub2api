...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAIOAuthHandler := admin.NewOpenAIOAuthHandler(openAIOAuthService, openAIQuotaService, adminService)

...
func (s *stubAdminService) GetUserBalanceHistory(ctx context.Context, userID int64, page, pageSize int, codeType string) ([]service.RedeemCode, int64, service.BalanceHistorySummary, error) {
	return s.redeems, int64(len(s.redeems)), service.BalanceHistorySummary{TotalRecharged: 100.0}, nil
}

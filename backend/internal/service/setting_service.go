...
// system block switch, custom expansion prompt, and configurable blocks JSON.
// Empty prompt/blocks means the gateway uses the built-in Claude Code defaults.

...
func validatePlanRequired(name string, groupID int64, price float64, validityDays int, validityUnit string, originalPrice *float64, purchaseLimitPerUser int) error {
...
func (s *PaymentConfigService) CreatePlan(ctx context.Context, req CreatePlanRequest) (*dbent.SubscriptionPlan, error) {
	if err := validatePlanRequired(req.Name, req.GroupID, req.Price, req.ValidityDays, req.ValidityUnit, req.OriginalPrice, req.PurchaseLimitPerUser); err != nil {
		return nil, err
	}
	b := s.entClient.SubscriptionPlan.Create().
		...
		SetPurchaseLimitPerUser(req.PurchaseLimitPerUser).
...
func (s *PaymentConfigService) UpdatePlan(ctx context.Context, id int64, req UpdatePlanRequest) (*dbent.SubscriptionPlan, error) {
	...
	if req.PurchaseLimitPerUser != nil {
		u.SetPurchaseLimitPerUser(*req.PurchaseLimitPerUser)
	}
	if req.ForSale != nil {

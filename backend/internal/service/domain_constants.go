...
// mapUpstreamStatus preserves meaningful upstream status codes while
// normalizing transport and unexpected responses to Bad Gateway.
...
const (
	...
	// Upstream Monitor
	SettingKeyUpstreamMonitorConfig = "upstream_monitor_config" // JSON 配置
)

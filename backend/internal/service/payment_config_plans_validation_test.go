...
func TestValidatePlanRequired_AllValid(t *testing.T) {
	err := validatePlanRequired("Pro", 1, 9.99, 30, "days", nil, 0)
	require.NoError(t, err)
}

func TestValidatePlanRequired_EmptyName(t *testing.T) {
	err := validatePlanRequired("", 1, 9.99, 30, "days", nil, 0)
	require.Error(t, err)
...
func TestValidatePlanRequired_ZeroGroupID(t *testing.T) {
	err := validatePlanRequired("Pro", 0, 9.99, 30, "days", nil, 0)
	require.Error(t, err)
...
func TestValidatePlanRequired_NameValidatedFirst(t *testing.T) {
	err := validatePlanRequired("", 0, 0, 0, "", nil, 0)
	require.Error(t, err)
	require.Contains(t, err.Error(), "plan name")
}
...
func TestValidatePlanRequired_NegativeOriginalPrice(t *testing.T) {
	neg := -10.0
	err := validatePlanRequired("Pro", 1, 9.99, 30, "days", &neg, 0)
	require.Error(t, err)
...
func TestValidatePlanRequired_ZeroOriginalPrice(t *testing.T) {
	zero := 0.0
	err := validatePlanRequired("Pro", 1, 9.99, 30, "days", &zero, 0)
	require.NoError(t, err)
}

func TestValidatePlanRequired_ValidOriginalPrice(t *testing.T) {
	op := 19.99
	err := validatePlanRequired("Pro", 1, 9.99, 30, "days", &op, 0)
	require.NoError(t, err)
}

func TestValidatePlanRequired_NegativePurchaseLimit(t *testing.T) {
	err := validatePlanRequired("Pro", 1, 9.99, 30, "days", nil, -1)
	require.Error(t, err)
...
func TestValidatePlanPatch_NegativePurchaseLimit(t *testing.T) {
	neg := -1
	err := validatePlanPatch(UpdatePlanRequest{PurchaseLimitPerUser: &neg})
	require.Error(t, err)
	require.Contains(t, err.Error(), "purchase limit")
}

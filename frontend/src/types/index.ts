...
export type GroupPlatform = 'anthropic' | 'openai' | 'zhipu' | 'gemini' | 'antigravity' | 'grok' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'zhipu' | 'gemini' | 'antigravity' | 'grok'
...
export interface UsageStatsResponse {
  ...
  total_account_cost: number // 账号成本，用户接口缺失时按 0 展示

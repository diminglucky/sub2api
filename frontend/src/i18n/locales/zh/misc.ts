export default {
  ...
  payment: {
    ...
    tabRechargeCard: '充值卡',
    tabSubscribe: '订阅',
    buyRechargeCard: '购买充值卡',
    rechargePackages: '充值套餐',
    rechargePackagesHint: '选择固定套餐后按套餐实付金额下单',
    rechargePackageCredit: '到账余额 {amount}',
    selectedRechargePackage: '已选择',
    selectRechargePackage: '选择',
    noRechargeCardProducts: '暂无可购买的充值卡',
    rechargeCardRedeemHint: '购买后会获得卡密，可在兑换码页面兑换到账户。',
    goRedeem: '去兑换',
    cardAmount: '面值 {amount}',
    cardPrice: '售价 {price}',
    cardExternalPurchase: '外部购买',
    rechargeCardDialogSubtitle: '通过外部购买链接购买卡密',
    rechargeCardAmountLabel: '充值卡面值',
    rechargeCardPriceLabel: '购买价格',
    rechargeCardHowToUse: '如何使用',
    openRechargeCardPurchase: '打开购买链接',
    scanRechargeCardQr: '扫码购买',
    scanRechargeCardQrHint: '也可以用手机扫码打开购买页面',
    noPlans: '暂无可用订阅套餐',

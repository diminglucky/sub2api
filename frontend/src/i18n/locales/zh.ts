export default {
  ...
  home: {
    ...
    publicModels: {
      eyebrow: '模型价格',
      title: '公开模型价格',
      description: '无需登录即可查看当前公开分组可用的模型和价格。点击模型卡片可查看不同分组倍率下的实际价格。',
      groups: '个公开分组',
      publicOnly: '仅公开分组',
      priceHint: '公开展示价格按分组默认倍率计算，登录后可能看到你的专属分组或专属倍率。'
    },
    // 新增：面向用户的价值主张
  ...
  models: {
    ...
    output: '输出',
    groupPrices: '各分组价格',
    groupPricesHint: '已按分组倍率计算实际扣费',
    noGroupPrices: '该模型暂无可用分组价格',
    multiplier: '倍率',
    requestPrice: '请求价格',
    imagePrice: '图片价格',
    standardGroup: '标准分组',
  ...
  admin: {
    ...
    channelMonitor: {
      ...
      form: {
        ...
        jitterSecondsHint: '每轮在检测间隔基础上随机提前或延后，最大不能让实际间隔低于 15 秒',
        enabled: '启用监控',
        kindRequired: '请选择供应商'
      },
      runResultTitle: '检测结果',
    ...
    accounts: {
      ...
      openaiQuotaReset: {
        count: '次数',
        countTooltipLoad: '查询上游重置次数',
        countTooltipRefreshTime: '上次查询：{time}',
        reset: '重置',
        resetTooltipReady: '消耗 1 次上游重置次数',
        queryFailed: '查询失败',
        resetFailed: '重置失败'
      },
      tier: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        cchSigning: 'CCH 兼容位',
        cchSigningHint: '历史兼容配置位，当前不再影响转发行为，仅保留以兼容旧数据。',
        claudeOAuthSystemPromptInjection: 'Claude OAuth 系统块注入',
        claudeOAuthSystemPromptInjectionHint: '为使用 Claude OAuth 账号的非 Claude Code 客户端注入兼容 Claude Code 的 system blocks。除非确认上游接受原始客户端提示词，否则建议保持开启。',
        claudeOAuthSystemPrompt: '扩展提示词',
      ...
      site: {
        ...
        apiBaseUrl: 'API 端点地址',
        apiBaseUrlHint: '用于"使用密钥"、Playground 和"导入到 CC Switch"功能。留空则用户侧默认显示 https://api.dihappy.cfd/v1',
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: '充值到账倍率，例如 1 表示支付 ¥10 到账 ¥10',
        balanceRechargePreview: '预览：¥1 = ¥{usd}',
        rechargePackages: '充值套餐',
        rechargePackagesHint: '配置用户在在线充值页看到的固定额度，到账额度和实际支付金额可不同。',
        addRechargePackage: '添加套餐',
        noRechargePackages: '暂无充值套餐，用户将回退为自定义金额输入。',
        rechargePackageName: '套餐名称',
        rechargePackageAmount: '到账额度',
        rechargePackagePayAmount: '支付金额',
        rechargePackageSort: '排序',
        rechargePackagePreview: '支付 ¥{pay}，到账 ¥{amount}',
        rechargePackagesIncomplete: '充值套餐需填写名称、到账额度和支付金额',
        rechargePackageDuplicate: '充值套餐 ID 重复，请删除重复项后再保存',
        ...
        rechargeCardProducts: '卡密购买商品',
        rechargeCardProductsHint: '每一行会在用户充值页生成一个购买按钮，用户点击后跳转到绑定的卡密购买链接。',
        addRechargeCardProduct: '添加商品',
        noRechargeCardProducts: '暂无卡密购买商品',
        rechargeCardName: '按钮名称',
        rechargeCardNamePlaceholder: '例如：10 元卡密',
        rechargeCardAmount: '面值',
        rechargeCardPrice: '售价',
        rechargeCardSort: '排序',
        rechargeCardEnabled: '启用',
        rechargeCardUrl: '购买链接',
        rechargeCardProductsIncomplete: '卡密商品需要填写按钮名称和购买链接',
        providerEasypay: '易支付',
        ...
        field_creemApiBaseHint: '生产环境使用 https://api.creem.io/v1，测试环境使用 https://test-api.creem.io/v1，主机和路径必须与环境一致。',
        field_cid: '支付渠道 ID',
        ...
        creemWebhookHint: '请在 Creem 后台将以下地址配置为 Webhook 端点，并订阅 checkout.completed 事件。',
        creemGuideSummary: '为付款流程使用的同一个产品创建 Creem API Key 和签名密钥。',
        creemGuideNote: '该接入会为已配置的产品创建 Creem checkout session，并通过 webhook 确认支付完成。',
        limitsTitle: '限额配置',
        limitSingleMin: '单笔最低',
        limitSingleMax: '单笔最高',
        limitDaily: '每日限额',
  ...
  payment: {
    ...
    quickAmounts: '快捷金额',
    rechargePackages: '选择充值套餐',
    rechargePackageCredit: '充值额度 ¥{amount}',
    ...
    buyRechargeCard: '购买卡密',
    cardAmount: '面值 ¥{amount}',
    cardPrice: '售价 ¥{price}',
    cardExternalPurchase: '第三方购买',
    rechargeCardPurchaseFrameTitle: '卡密购买页面',
    openRechargeCardPurchase: '打开购买页',
    rechargeCardDialogSubtitle: '扫码购买，购买后回到兑换页输入卡密',
    rechargeCardAmountLabel: '卡密面值',
    rechargeCardPriceLabel: '购买价格',
    rechargeCardHowToUse: '购买后如何使用',
    scanRechargeCardQr: '扫码购买',
    scanRechargeCardQrHint: '使用手机支付宝或浏览器扫码打开购买链接',
    payNow: '去支付',
    ...
    tabTopUp: '充值',
    tabRechargeCard: '购买卡密',
    tabSubscribe: '订阅',
    tabRedeem: '兑换',
    goRedeem: '去兑换',
    noRechargeCardProducts: '后台暂未配置卡密商品',
    rechargeCardRedeemHint: '购买完成后，请回到兑换页输入卡密完成到账。',
    noPlans: '暂无可用订阅套餐',
    ...
    rechargeRatePreview: '当前倍率：¥1 = ¥{usd}',
    refundReason: '退款原因',

export default {
  ...
  payment: {
    ...
    rechargePackagesHint: 'Select a fixed package to pay its package price',
    rechargePackageCredit: 'Credits {amount}',
    selectedRechargePackage: 'Selected',
    selectRechargePackage: 'Select',
    noRechargeCardProducts: 'No recharge cards available',
    rechargeCardRedeemHint: 'After purchase, redeem the card code on the redeem page.',
    goRedeem: 'Redeem',
    cardAmount: 'Value {amount}',
    cardPrice: 'Price {price}',
    cardExternalPurchase: 'External purchase',
    rechargeCardDialogSubtitle: 'Buy a card code from the external purchase link',
    rechargeCardAmountLabel: 'Card Value',
    rechargeCardPriceLabel: 'Purchase Price',
    rechargeCardHowToUse: 'How to Use',
    openRechargeCardPurchase: 'Open Purchase Link',
    scanRechargeCardQr: 'Scan to Buy',
    scanRechargeCardQrHint: 'You can also scan this QR code on mobile',

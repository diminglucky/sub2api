export default {
    ...
    groups: {
      ...
      copyAccounts: {
        ...
        tooltip: 'Select one or more groups of the same platform. After creation, their accounts and channel association are inherited so the new rate uses the same model pricing.',
        tooltipEdit: 'Select one or more groups of the same platform. After saving, current group accounts will be replaced with accounts from these groups (deduplicated); channel association is inherited only when creating a group.',
        selectPlaceholder: 'Select groups to copy accounts from...',
        hint: 'Multiple groups can be selected; accounts and channel association are deduplicated',

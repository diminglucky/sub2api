export default {
  ...
  home: {
    ...
    publicModels: {
      ...
      description: 'View publicly available models and prices without signing in. Click a model card to see effective prices under each public group multiplier.',
      groups: 'public groups',
      publicOnly: 'Public groups only',
      priceHint: 'Public prices are calculated with default group multipliers. After signing in, you may see dedicated groups or user-specific rates.'
    },
  ...
  models: {
    ...
    groupPricesHint: 'Calculated with each group multiplier',
    noGroupPrices: 'No group price is available for this model',
  ...
  redeem: {
    ...
    balanceAddedRedeem: 'Balance Added (Redeem Code)',
  ...
  admin: {
    ...
    users: {
      ...
      allTypes: 'All Types',
      typeBalance: 'Balance (Online Payment / Redeem Code)',
      ...
      sourceOnlineRecharge: 'Online Payment',
    ...
    channelMonitor: {
      ...
      form: {
        ...
        jitterSecondsHint: 'Randomly shifts each run earlier or later; actual interval must stay at least 15 seconds',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        cchSigningHint: 'Legacy compatibility setting retained for old data; it no longer affects forwarding behavior.',
        claudeOAuthSystemPromptInjection: 'Claude OAuth System Blocks',
        claudeOAuthSystemPromptInjectionHint: 'Inject Claude Code-compatible system blocks for non-Claude-Code clients using Claude OAuth accounts. Leave enabled unless you know the upstream accepts the original client prompt.',
        ...
        claudeOAuthSystemPromptHint: 'Replaces {claude_code_expansion_prompt} in the default/custom blocks. Empty keeps the built-in prompt.',
        claudeOAuthSystemPromptBlocks: 'System Blocks JSON',
        claudeOAuthSystemPromptBlocksPlaceholder: 'System Blocks JSON example: fill in the blocks array',
        claudeOAuthSystemPromptBlocksHint: 'Optional JSON. Supports {billing_header}, {cc_version}, {fp}, {claude_code_system_prompt}, and {claude_code_expansion_prompt}.',
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: 'Recharge multiplier. For example, 1 means paying ¥10 credits ¥10.',
        balanceRechargePreview: 'Preview: ¥1 = ¥{usd}',
        rechargePackages: 'Recharge Packages',
        rechargePackagesHint: 'Configure fixed packages shown on the recharge page. Credited balance and payment amount can differ.',
        addRechargePackage: 'Add Package',
        noRechargePackages: 'No recharge packages yet. Users will fall back to custom amount input.',
        rechargePackageName: 'Package Name',
        rechargePackageAmount: 'Credited Balance',
        rechargePackagePayAmount: 'Payment Amount',
        rechargePackageSort: 'Sort',
        rechargePackagePreview: 'Pay ¥{pay}, credit ¥{amount}',
        rechargePackagesIncomplete: 'Recharge packages require name, credited balance, and payment amount.',
        rechargePackageDuplicate: 'Recharge package IDs are duplicated. Please remove duplicates and save again.',
        ...
        rechargeCardProducts: 'Recharge Card Products',
        rechargeCardProductsHint: 'Each row creates a purchase button on the user recharge page. Clicking it opens the bound card purchase URL.',
        addRechargeCardProduct: 'Add Product',
        noRechargeCardProducts: 'No recharge card products yet',
        rechargeCardName: 'Button Name',
        rechargeCardNamePlaceholder: 'Example: 10 CNY Card',
        rechargeCardAmount: 'Value',
        rechargeCardPrice: 'Price',
        rechargeCardSort: 'Sort',
        rechargeCardEnabled: 'Enabled',
        rechargeCardUrl: 'Purchase URL',
        rechargeCardProductsIncomplete: 'Recharge card products need a button name and purchase URL',
        ...
        field_creemApiBaseHint: 'Use https://api.creem.io/v1 for production or https://test-api.creem.io/v1 for test mode. The host and path must match the environment.',
        ...
        creemWebhookHint: 'Configure the following URL as a Webhook endpoint in Creem. Select checkout.completed and use the signing secret from the Creem dashboard.',
        creemGuideSummary: 'Create a Creem API key and signing secret for the same product used by the checkout flow.',
        creemGuideNote: 'This integration creates a Creem checkout session for the configured product and uses the webhook to confirm payment completion.',
        limitsTitle: 'Limits',
  ...
  payment: {
    ...
    rechargePackages: 'Choose a Recharge Package',
    rechargePackageCredit: 'Credit ¥{amount}',
    selectRechargePackage: 'Select',
    selectedRechargePackage: 'Selected',
    ...
    buyRechargeCard: 'Buy Recharge Card',
    cardAmount: 'Value ¥{amount}',
    cardPrice: 'Price ¥{price}',
    cardExternalPurchase: 'External purchase',
    rechargeCardPurchaseFrameTitle: 'Recharge card purchase page',
    openRechargeCardPurchase: 'Open Purchase Page',
    rechargeCardDialogSubtitle: 'Scan to buy, then return to redeem the card code',
    rechargeCardAmountLabel: 'Card Value',
    rechargeCardPriceLabel: 'Purchase Price',
    rechargeCardHowToUse: 'How to use after purchase',
    scanRechargeCardQr: 'Scan to Buy',
    scanRechargeCardQrHint: 'Scan with mobile Alipay or a browser to open the purchase link',
    payNow: 'Pay',
    ...
    tabTopUp: 'Top Up',
    tabRechargeCard: 'Recharge Card',
    tabSubscribe: 'Subscribe',
    tabRedeem: 'Redeem',
    goRedeem: 'Redeem',
    noRechargeCardProducts: 'No recharge card products are configured yet',
    rechargeCardRedeemHint: 'After purchase, return to the redeem page and enter the card code.',

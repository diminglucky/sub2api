    ...
    settings: {
      ...
      upstreamMonitor: {
        ...
        sources: {
          ...
          description: 'Register each upstream with pricing endpoint, auth mode, currency, and notes. Future checks will read from here.',
          add: 'Add Source',
          empty: 'No upstream sources configured yet.',
          untitled: 'Untitled Source #{index}',
          untitledShort: 'Untitled Source',
          noUrl: 'No endpoint URL configured yet',
          noGroups: 'No groups',
          syncHint: 'Auto sync currently supports two response styles: JSON endpoints and plain numeric text. For complex webpages, provide a direct API endpoint when possible.',
          pullGroups: 'Pull Upstream Groups',
          pullingGroups: 'Pulling',
          pullGroupsHint: 'Fill the pricing endpoint first, then pull groups.',
          applyPreset: 'Apply Endpoint',
          applyPresetSuccess: 'Default endpoint settings were generated for this source type.',
          applyPresetMissingBaseUrl: 'Fill the site URL first, for example https://pool.gptstore.club',
          pullGroupsMissingUrl: 'Fill the pricing endpoint URL first',
          ...
          tokenHint: 'Fill this in if the upstream pricing endpoint requires authentication.',
          ...
          basic: {
            ...
            description: 'Daily setup only needs these fields: source name, pricing endpoint, reference multiplier, auto sync, and covered local groups.',
          },
          advanced: {
          ...
          fields: {
            ...
            autoSync: 'Auto Sync',
            autoSyncHint: 'When enabled, the pricing endpoint can refill the reference multiplier automatically.',
            fetchMode: 'Fetch Mode',
            baseUrl: 'Site URL',
            baseUrlPlaceholder: 'https://pool.gptstore.club',
            baseUrlHint: 'Enter the upstream relay homepage domain. "Apply Endpoint" will generate the pricing endpoint.',
            ...
            sourceReferenceFallback: 'Use Source Reference Multiplier',
            ...
            manualUpstreamGroup: 'Enter Upstream Group Manually',
            ...
            upstreamGroupEmptyHint: 'After filling the pricing endpoint and clicking "Pull Upstream Groups", selectable upstream groups will appear here.',
            pathFallback: 'No ID, matched by path',
            upstreamGroup: 'Upstream Relay Group',
            upstreamGroupHint: 'The group name used by the upstream relay. Defaults to the local group name when left empty.',
            mappingReferenceMultiplier: 'Mapping Upstream Multiplier',
            mappingReferenceMultiplierHint: 'Use this when upstream groups have different costs. Leave empty or 0 to use the source reference multiplier.',
            mappingReferenceMultiplierAutoHint: 'This mapping is bound to a synced upstream group, so the latest pulled upstream multiplier is used. Switch back to manual upstream group entry to edit it.',

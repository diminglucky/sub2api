                  ...
                  <div v-else class="space-y-3">
                    ...
                    >
                      <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-6">
                        <div class="lg:col-span-2">
                          <label class="input-label">{{ t("admin.settings.payment.rechargeCardName") }}</label>
                          <input
                        ...
                        <div>
                          <label class="input-label">{{ t("admin.settings.payment.rechargeCardAmount") }}</label>
                          <input v-model.number="product.amount" type="number" min="0" step="0.01" class="input" />
                        </div>
                        <div>
                          <label class="input-label">{{ t("admin.settings.payment.rechargeCardPrice") }}</label>
                          <input v-model.number="product.price" type="number" min="0" step="0.01" class="input" />
                        </div>
                        <div>
                          <label class="input-label">{{ t("admin.settings.payment.rechargeCardSort") }}</label>
                          <input v-model.number="product.sort_order" type="number" step="1" class="input" />
                        </div>
                        <div>
                          <label class="input-label">{{ t("admin.settings.payment.rechargeCardEnabled") }}</label>
                          <button
                            type="button"
                            :class="[
                      ...
                      <div class="mt-3 grid gap-3 lg:grid-cols-[1fr_auto]">
                        <div>
                          <label class="input-label">{{ t("admin.settings.payment.rechargeCardUrl") }}</label>
                          <input v-model="product.url" type="url" class="input" placeholder="https://pay.example.com/item" />
                        </div>
                        <div class="flex items-end">
                          <button
                            type="button"

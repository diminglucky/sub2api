...
export type Platform = 'anthropic' | 'openai' | 'zhipu' | 'antigravity' | 'gemini' | 'grok'
...
const BADGE: Record<Platform, string> = {
  ...
  zhipu: 'bg-cyan-500/10 text-cyan-600 border-cyan-500/30 dark:text-cyan-400',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  zhipu: 'bg-cyan-500/10 text-cyan-600 dark:bg-cyan-500/10 dark:text-cyan-300',
...
const BORDER: Record<Platform, string> = {
  ...
  zhipu: 'border-cyan-500/20 dark:border-cyan-500/20',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  zhipu: 'bg-gradient-to-r from-cyan-400 to-cyan-500',
  antigravity: 'bg-gradient-to-r from-purple-400 to-purple-500',
  gemini: 'bg-gradient-to-r from-blue-400 to-blue-500',
  grok: 'bg-gradient-to-r from-slate-500 to-zinc-600',
}
...
const ICON: Record<Platform, string> = {
  ...
  zhipu: 'text-cyan-500 dark:text-cyan-400',
...
const BUTTON: Record<Platform, string> = {
  ...
  zhipu: 'bg-cyan-600 text-white hover:bg-cyan-700 active:bg-cyan-800 dark:bg-cyan-600/80 dark:hover:bg-cyan-600',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  zhipu: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  zhipu: 'from-cyan-500 to-cyan-600',
  antigravity: 'from-purple-500 to-purple-600',
  gemini: 'from-blue-500 to-blue-600',
  grok: 'from-slate-600 to-zinc-700',
}
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'zhipu' || p === 'antigravity' || p === 'gemini' || p === 'grok'
}

<template>
  ...
  <!-- Zhipu GLM logo (simple hex spark) -->
  <svg v-else-if="platform === 'zhipu'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2.5 20.23 7.25v9.5L12 21.5l-8.23-4.75v-9.5L12 2.5zm0 3.2L6.55 8.85v6.3L12 18.3l5.45-3.15v-6.3L12 5.7z" />
    <path d="M12 7.5 13.1 11l3.4 1-3.4 1L12 16.5 10.9 13l-3.4-1 3.4-1L12 7.5z" />
  </svg>

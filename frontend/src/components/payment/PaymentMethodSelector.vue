...
function methodIcon(type: string): string {
  ...
  if (type === 'creem') return METHOD_ICONS.creem
...
function methodSelectedClass(type: string): string {
  ...
  if (type === 'creem') return 'border-[#8B5CF6] bg-violet-50 text-gray-900 shadow-sm dark:border-[#A78BFA] dark:bg-violet-950 dark:text-gray-100'
